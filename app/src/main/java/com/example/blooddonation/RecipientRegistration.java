    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(RecipientRegistration.this,Loginactivity.class);
                            ...
                            if(!task.isSuccessful()){
                                ...
                                userDatabaseref.updateChildren( userinfo ).addOnCompleteListener( new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(  RecipientRegistration.this,"Successfull Registration..",Toast.LENGTH_SHORT ).show();
                                                ...
                                                result.addOnSuccessListener( new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseref.updateChildren( newImageMap ).addOnCompleteListener( new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful()){
                                                                    Toast.makeText(  RecipientRegistration.this,"Image url is added to database successfully",Toast.LENGTH_SHORT ).show();
                                                                }else{
                                                                    Toast.makeText(  RecipientRegistration.this,task.getException().toString(),Toast.LENGTH_SHORT ).show();
